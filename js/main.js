...
requirejs(['phaser', 'util', 'boot', 'gametitle', 'howto', 'preload', 'level', 'winner'],
    function(phaser, util, boot, gametitle, howto, preload, level, winner)
    {
        ...
        $(document).ready(function()
        {
            ...
            function startGame(levels)
            {
                ...
                game.state.add("Winner", this.winner);
